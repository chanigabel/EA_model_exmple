'MasterDocumentConnectorsOperations
...
Sub create_document(repository, documents_package_GUID)
    ...
    If Not master_document Is Nothing Then
        If Not documentation_diagram Is Nothing Then
            Dim i
            i = 0
            add_model_document_for_diagram repository, master_document, documentation_diagram, "Connectors Documentation", i, "Connector_tm"
            i = i + 1
            add_model_document_for_diagram repository, master_document, documentation_diagram, "Operations Documentation", i, "Operation_tm"
            i = i + 1
